...
const colouredLinesChart = {
  data: {
    ...
    series: [
      // [2.8, 3.8, 4.9, 5.5, 5.8, 6.98, 6.95, 7.52, 7.88, 8.46, 9.44],
      [6.7, 5.2, 4.3, 8.7, 3.5, 4.35, 4.37, 5.39, 5.42, 5.44, 6.47],
      // [2.3, 5.3, 6.7, 9.0, 3.9, 3.7, 7.8, 4.9, 4.1, 4.1, 5.9],
    ],
  },
  options: {
    lineSmooth: Chartist.Interpolation.cardinal({
